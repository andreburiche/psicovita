...
<head>
    ...
    <title>{{ $appName }} — {{ __('Redefinir palavra-passe') }}</title>
</head>
<body style="margin:0;padding:0;background-color:#eef2ff;-webkit-text-size-adjust:100%;">
    <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">
        {{ __('Pedido de redefinição de palavra-passe no :app.', ['app' => $appName]) }}
    </div>
                                ...
                                <tr>
                                    <td style="padding:32px 32px 8px;font-family:ui-sans-serif,system-ui,Segoe UI,Roboto,sans-serif;">
                                        ...
                                        <p style="margin:0 0 28px;font-size:15px;line-height:1.65;color:#475569;">
                                            {{ __('Utilize o botão abaixo para escolher uma nova palavra-passe. Por segurança, o link expira em :count minutos.', ['count' => $expireMinutes]) }}
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td align="center" bgcolor="#7c3aed" style="border-radius:14px;background:linear-gradient(135deg,#7c3aed 0%,#6366f1 100%);background-color:#7c3aed;">
                                                    <a href="{{ $resetUrl }}" target="_blank" rel="noopener" style="display:inline-block;padding:16px 36px;font-family:ui-sans-serif,system-ui,Segoe UI,Roboto,sans-serif;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;border-radius:14px;">
