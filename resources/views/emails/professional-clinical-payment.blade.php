...
<head>
    ...
    <title>{{ $appName }} — {{ __('Pagamento clínico') }}</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:560px;background:#fff;border-radius:20px;overflow:hidden;box-shadow:0 16px 48px rgba(91,33,182,0.12);">
                    <tr>
                        <td style="background:linear-gradient(135deg,#7c3aed,#4f46e5);padding:28px 32px;color:#fff;font-family:system-ui,sans-serif;">
                            ...
                            <p style="margin:10px 0 0;font-size:13px;opacity:0.9;">{{ __('Financeiro clínico') }}</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:32px;font-family:system-ui,sans-serif;color:#334155;">
                            ...
                            <a href="{{ $paymentUrl }}" style="display:inline-block;background:linear-gradient(135deg,#7c3aed,#4f46e5);color:#fff;text-decoration:none;padding:14px 24px;border-radius:12px;font-weight:700;font-size:15px;">{{ __('Ver pagamento') }}</a>
                        </td>
                    </tr>
                </table>
            </td>
