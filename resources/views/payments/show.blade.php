<x-app-layout>
    ...
    @php
        ...
        $heroSurface = match ($payment->status) {
            ...
            \App\Enums\PaymentStatus::Pending => 'border-amber-200/90 bg-gradient-to-br from-amber-50 via-orange-50 to-amber-100 dark:border-amber-800/60 dark:from-amber-950/50 dark:via-orange-950/40 dark:to-slate-900',
        ...
        $heroAccent = match ($payment->status) {
            ...
            \App\Enums\PaymentStatus::Pending => 'text-amber-950 dark:text-amber-50',
        ...
        $heroMuted = match ($payment->status) {
            ...
            \App\Enums\PaymentStatus::Pending => 'text-amber-900/75 dark:text-amber-200/80',
        ...
        $heroSubcard = match ($payment->status) {
            ...
            \App\Enums\PaymentStatus::Pending => 'bg-white/80 ring-amber-200/80 dark:bg-white/5 dark:ring-amber-800/50',
        ...
        $methodChip = match ($payment->status) {
            ...
            \App\Enums\PaymentStatus::Pending => 'bg-amber-100 text-amber-950 ring-amber-300/60 dark:bg-amber-950/60 dark:text-amber-100 dark:ring-amber-700/50',
