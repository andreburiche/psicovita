...
class StoreDocumentRequestRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $this->user()?->can('create', [\App\Models\DocumentRequest::class, $patient]) ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'patient_consent_confirmed' => ['accepted'],
    ...
    {
        return [
            'patient_consent_confirmed.accepted' => __('É obrigatório confirmar o consentimento do paciente ou responsável (LGPD).'),
            'requested_documents.required' => __('Selecione ou informe ao menos um documento solicitado.'),
        ];
    }
