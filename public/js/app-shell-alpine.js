/**
 * Shell da área profissional — sidebar mobile com focus trap (CDN Alpine).
 * Manter alinhado a resources/js/app-shell.js
 */
(function () {
    function createAppShellData() {
        return {
            sidebarOpen: false,
            ...
            closeSidebar(restoreFocus) {
                ...
                if (restoreFocus && this.sidebarLastFocus && this.sidebarLastFocus.focus) {
            ...
            sidebarFocusables() {
                ...
                return [...aside.querySelectorAll(selector)].filter(function (el) {
    ...
    document.addEventListener('alpine:init', function () {
        ...
        window.Alpine.data('appShell', createAppShellData);
    });
})();
